export type WidgetType = 'ranking' | 'throne' | 'goal' | 'affinity' | 'battle' | 'team_battle' | 'timer' | 'messages' | 'alert' | 'roulette' | 'music' | 'gacha' | 'physics' | 'territory' | 'weather' | 'train' | 'slots' | 'meter' | 'quiz' | 'rpg';
