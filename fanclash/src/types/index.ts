export type WidgetType = 'ranking' | 'throne' | 'goal' | 'affinity' | 'battle' | 'team_battle' | 'timer' | 'messages' | 'alert' | 'roulette' | 'gacha' | 'physics' | 'territory' | 'train' | 'slots' | 'meter' | 'quiz' | 'rpg' | 'mission';
