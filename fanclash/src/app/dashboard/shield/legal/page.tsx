...
const guides = [
  ...
  },
  {
    ...
    content: [
      ...
      '6. 날짜 및 서명',
      '',
      'FanClash 댓글 방어의 리포트를 증거 자료로 첨부하실 수 있습니다.',
    ],
  },
  {
    title: '증거 보존 방법',
    ...
    content: [
      ...
      'FanClash에 댓글을 등록하면 타임스탬프와 함께 자동 보존됩니다.',
    ],
  },
  {
    title: '유용한 링크',
...
export default function LegalGuidePage() {
  return (
    <div className="pt-12 md:pt-0 max-w-3xl">
      <h1 className="text-2xl font-bold mb-2">법적 대응 가이드</h1>
        ...
        {guides.map((guide) => (
          <div key={guide.title} className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-2xl" dangerouslySetInnerHTML={{ __html: guide.icon }} />
