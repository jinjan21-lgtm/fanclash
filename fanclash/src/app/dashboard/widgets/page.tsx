...
const ALL_WIDGET_TYPES: WidgetType[] = ['alert', 'ranking', 'throne', 'goal', 'affinity', 'battle', 'team_battle', 'timer', 'messages', 'roulette', 'gacha', 'physics', 'territory', 'train', 'slots', 'meter', 'quiz', 'rpg', 'mission'];
