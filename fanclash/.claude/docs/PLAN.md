...
- 배틀 관리: 위젯 관리 페이지 내에서 배틀 개설/시작/취소 (위젯 설정값 연동)
...
| 2026-03-12 | 룰렛 DB 제약조건 수정, 배틀 설정값 연동 | 룰렛 위젯 생성 불가 버그 + 배틀 설정 불일치 수정 |
| 2026-03-12 | Free 요금제: 위젯 3개 → alert 1개만 허용 | 무료/유료 차별화 강화 |
